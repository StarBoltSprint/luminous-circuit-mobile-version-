...
/** HUD civic ticker. Rate stays 2–6 C/X. Line: Charge N · crystal M · quote 1 for R. If scripture>=1, append · scripture N. If scripture<1, append · Iri quiet. If bids>0, append · N waiting. If bids>=3, append · join busy. If crystal<3, append · kiln hungry. If charge<4, append · canal thin. If crystal>=12, append · stock fat. If charge>=16, append · canal fat. If charge>=24, append · canal full. If folk building>=1, append · dens rising. If folk building>=3, append · many dens. If folk building>=6, append · city rising. If scripture>=8, append · named. Line stays under 140. */
