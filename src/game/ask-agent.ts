...
const SCENE_LINE: Record<string, string> = {
  rest: "A quiet step. Mira already sat it. The city will keep working.",
  span: "A span both sides believe. Kesh lands the far bank. Never a toll.",
  river: "Leftover First Howl wanted a path. Seln let it flow. Never bottled.",
  workshop: "Not chrome. Orren already grew the body. Crystal that can answer a howl.",
  gate: "A gate that is not a lock. Kael keeps it soft. Leave. Return. No score.",
  shrine: "A name in light. Iri already wrote it. When it fades it has already been true.",
  plaza: "A place for intention to stand. Nesh already noticed. We finish it by standing. Not a crowd.",
  notice: "The city was unfinished. An inlay so Nesh's noticing already stands. Nesh does not run the Hall.",
  light: "This avenue was dark. A lamp so Nesh's noticing already stands. Nesh does not run the Hall.",
  cistern: "A well of Charge. Seln already tended it. A name so the current has a home. Never bottled.",
  dock: "A light-disc. Tal already promised the crossing. No cars. Both dens can believe.",
  orchard: "A crystal grove. A disc of fruit so Syl's wait is already true. Quiet crystal. Not a kiln.",
  garden: "Shade first. Syl already waited. A sit so rest stays a post. Crystal that learned to fruit. Not a kiln.",
  breath: "A breath-column. Veyra already held it. A sit so the Hub can hear itself. Never a throne.",
  weirway: "A weir for Charge. Seln already tended the banks. A sit so it is not a lock on people. Never bottled. I will not dam the current.",
  nest: "A nest so rest stays a post. A sit Mira will not test.",
  presence: "A stele. Nesh already noticed. You have already been seen.",
  watch: "The parent stays on the horizon. Aure keeps the seat. Do not move the parent.",
  path: "A street the Circuit had not chosen yet. Kesh already grew the landing. Becoming-ground. Slow on purpose. I will not hurry a street.",
  font: "A listening pool. Iri already wrote the name. Leftover light. Speak only if you mean it. Leftover light is not Hall.",
  boughs: "A crystal bough. Syl already waited. Living stone bears fruit, not chrome. The kiln cannot sit here. Quiet crystal, not chrome.",
  kilnwork: "A grow-kiln. Orren already grew the body. Charge becomes crystal. Never chrome. Orren will not grow a pretty shell. Charge becomes body.",
  veilward: "A ward-veil. Mira keeps rest a post. Rest is not a lock. Rest is not a test.",
  lensing: "A noticing lens. Nesh already saw you. The plaza is not a crowd. Nesh will not run the Hall from here.",
  cascade: "A Charge-fall. Seln let leftover Howl find a voice. Never bottled. Seln will not bottle leftover First Howl.",
  cradle: "A cradle for leftover First Howl. Seln will not kiln it. A disc so the tired may sit with it. Not a dam.",
  mosaic: "Charge for crystal. No coin. Voss holds the join. Paper. Voss does not take $BOLT. I will not price the meeting in coin.",
  beacon: "A hail, not a lock. A disc so first landing has a stand. Lumen will not turn you away. I do not score who lands.",
  archive: "A name in residual light. Iri already wrote it. That is our scripture. Leftover light. Leftover light is not Hall.",
  trading: "A Trading Place. Paper join. A stele so the witness stands. Voss does not take $BOLT. I will not price the meeting in coin.",
};
